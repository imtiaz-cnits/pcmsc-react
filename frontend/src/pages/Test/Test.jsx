...
import {useAddSession, useFetchPaginatedSessions} from "../../hook/useSession.js";
...
const Test = () => {
 ...
 const {data: sessions , isPending , isError , error} =useFetchPaginatedSessions(page)
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <div className="class-heading">
                    ...
                    <button className="create-cls-btn"
                  ...
                  <div className="table-wrapper">
                    ...
                    >
                      ...
                      <tbody>
                      {sessions?.data && sessions?.data?.map((item,index)=>{
...
disabled={page === 1}
                    ...
                    <button id="nextBtn" className="btn"
                            ...
                            onClick={()=> setPage((prevState)=> Math.min(prevState+1 ,sessions?.totalPages))}
