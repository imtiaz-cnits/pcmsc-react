                ...
                admitcards?.data?.length > 0 && admitcards?.data?.map((item,idx)=>(
                  ...
                  <div className="header">
                    ...
                    <div className="info">
                      ...
                      <h2>Zilla Para, Pabna Sadar Pabna</h2>
                      <h3>Admit Card</h3>
                    </div>
                  </div>
                  <div className="section table-wrapper">
                    <div className="info">
                      ...
                      >
                        <tr>
                          <td>
                            <strong>Name of the Examinee:</strong>
                          </td>
                          <td>
                            <span>{item?.examineName}</span>
                          </td>
                          <td>
                        ...
                        <tr>
                          <td>
                            <strong>Type of Examinee:</strong>
                          </td>
                          <td>
                            <span>{item?.exmType}</span>
                          </td>
                          <td>
                            <strong>Group:</strong>
                          </td>
