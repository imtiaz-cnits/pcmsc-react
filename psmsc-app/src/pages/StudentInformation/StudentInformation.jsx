...
const StudentInformation= ()=>{
    ...
    <div class="main-content">
      <div class="page-content">
                              ...
                              <div>
                                <ul>
                                  <li>
                                    <a
                                      href="#"
                                      class="link custom-open-modal-btn openModalBtn"
                                      data-modal="action-editmodal"
                                      >Edit</a>
              ...
              <div class="row">
                <div class="col-6">
                  <div class="item">
                    ...
                    <h3>Student Name: <span>Shanto</span></h3>
                    <h3>Student ID: <span>121777</span></h3>
                    <h3>Blood Group: <span>A+</span></h3>
                    <h3>Birth Certificate: <span>3453453435445</span></h3>
                    <h3>Father Name: <span>Jahangir</span></h3>
                    <h3>Father NID: <span>12132323424</span></h3>
                    <h3>Father Mobile: <span>01713223424</span></h3>
                    <h3>Mother Name: <span>shithi</span></h3>
                    <h3>Mother NID: <span>12132323424</span></h3>
                    <h3>Mother Mobile: <span>01732323424</span></h3>
                  </div>
                </div>
                <div class="col-6">
                  <div class="item">
                    <h3>Admission Number: <span>232434545</span></h3>
                    <h3>Admission Date: <span>2024-11-22</span></h3>
                    <h3>Present Address: <span>Pabna</span></h3>
                    <h3>Permanent Address: <span>Pabna</span></h3>
                    <h3>Guardian (In Absence of F/M): <span>Riyad</span></h3>
                    <h3>Guardian Mobile: <span>01832424343</span></h3>
                    <h3>Date of Birth: <span>2024-12-1</span></h3>
                    <h3>Student Email: <span>info@gmail.com</span></h3>
                    <h3>SMS Status: <span>Active</span></h3>
                    <h3>Registration Date: <span>2023-12-22</span></h3>
                    <h3>Shift Name: <span>Day</span></h3>
                    <h3>Session Name: <span>1st Semester</span></h3>
                    <h3>Student Gender: <span>Male</span></h3>
                    <h3>Section Name: <span>Science</span></h3>
                  </div>
                </div>
              </div>
            </div>
            <div class="modal-buttons">
              <button id="quickClose"><i class="fa-solid fa-x"></i></button>
            </div>
          </div>
        </div>
        ...
        <section id="studentModal" class="modal studentModal">
          <div class="modal-content">
            <div id="popup-modal">
              <div class="form-container">
                ...
                <form>
                  ...
                  <div class="form-row row">
                    ...
                    <div class="form-group col-lg-4">
                      <label for="vanilla-datepicker">Admission Date *</label>
                    ...
                    <div class="form-group col-lg-4">
                      <label for="name-bangla">Name in Bangla</label>
                      <input
                        type="text"
                        id="name-bangla"
                    ...
                    <div class="form-group select-input-box col-lg-4">
                      <label for="select-to">Blood Group</label>
                      ...
                      <div class="upload-profile">
                        <div class="item">
                          ...
                          <div class="profile-wrapper">
                            <label class="custom-file-input-wrapper m-0">
                              <input
                                type="file"
                  ...
                  <div class="form-row row">
                    ...
                    <div class="form-group col-lg-4">
                      <label for="father-nid">Father's NID</label>
                      <input
                        type="text"
                        id="father-nid"
                  ...
                  <div class="form-row row">
                    ...
                    <div class="form-group col-lg-4">
                      <label for="mother-nid">Mother's NID</label>
                      <input
                        type="text"
                        id="mother-nid"
                  ...
                  <div class="form-row row">
                    ...
                    <div class="form-group col-lg-4">
                      <label for="guardian">Guardian (In Absence of F/M)</label>
                      <input
                        type="text"
                        id="guardian"
                  ...
                  <div class="form-row row">
                    <div class="form-group col-lg-4">
                      <label for="guardian-mobile">Guardian Mobile *</label>
                      <input
                        type="text"
                        id="guardian-mobile"
                    ...
                    <div class="form-group select-input-box col-lg-4">
                      <label for="select-to">Student Gender</label>
                      <div class="select-box-dropdown">
                        <div class="select-dropdown-selected">
                  ...
                  <div class="form-row row">
                    ...
                    <div class="form-group select-input-box col-lg-4">
                      <label for="select-to">SMS Status</label>
                      <div class="select-box-dropdown">
                        <div class="select-dropdown-selected">
                  ...
                  <div class="form-row row">
                    <div class="form-group select-input-box col-lg-4">
                      <label for="select-to">Shift Name</label>
                      <div class="select-box-dropdown">
                        <div class="select-dropdown-selected">
                  ...
                  <div class="form-actions">
                    <button type="button" id="closBtn" class="button close">
                      Close
                    </button>
