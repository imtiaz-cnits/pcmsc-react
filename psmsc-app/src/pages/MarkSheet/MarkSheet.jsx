          ...
          <div className="marksheet-container-wrap">
              ...
              <div className="info-wrapper">
                ...
                <div className="board-info">
                  ...
                  <div className="code-info">
                    <h4>EIIN: <span>451211</span></h4>
                    <div className="bar">|</div>
                    <h4>School Code: <span>451211</span></h4>
                  </div>
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><span>70-79</span></td>
                      <td><span>A</span></td>
                      <td><span>4.00</span></td>
                    </tr>
                    <tr>
                      <td><span>60-69</span></td>
                      <td><span>A-</span></td>
              ...
              <div className="student-info-table">
                <table className="student-info">
                  <tr>
                    ...
                    <td><span>IMTIAZ AHMED</span></td>
                    <td><span>Roll No:</span></td>
                    <td><span>116988</span></td>
                  </tr>
                  <tr>
                    <td><span>Father's Name:</span></td>
                    <td><span>MD. IQBAL HOSSAIN</span></td>

                    <td><span>Group:</span></td>
                    <td><span>Boys</span></td>
                  </tr>
                  <tr>
                    <td><span>Mother's Name:</span></td>
                    <td><span> MOST. FERDOUSI IQBAL</span></td>
                    <td><span>Exam:</span></td>
                    <td><span>Annual Exam</span></td>
                  </tr>
                  <tr>
                    <td><span>Student ID:</span></td>
                    <td><span>212469</span></td>
                    <td><span>Year/Session:</span></td>
                    <td><span>2025</span></td>
                  </tr>
                  <tr>
                    <td><span>className:</span></td>
                    <td colSpan="3"><span>6/Six</span></td>
                  </tr>
                </table>
              </div>
            </div>
            ...
            <div className="grade-sheet">
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th rowSpan="2" className="sub-name">Subject Name</th>
                  ...
                  <tbody>
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Bangla</span></td>
                      <td><span>100</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>English</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Mathematics</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Science</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Digital Technology</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Life and Livelihood</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td><span>101</span></td>
                      <td className="subject"><span>Art and Culture</span></td>
                      <td><span>100</span></td>
                      <td><span>99.3</span></td>
                      <td><span>-</span></td>
                      <td><span>98</span></td>
                    ...
                    <tr>
                      <td colSpan="2"><span>Total Exam Marks</span></td>
                      <td><span>1000</span></td>
                      <td colSpan="5"><span>Obtained Marks & GPA</span></td>
                      <td><span>990</span></td>
                      <td><span>A</span></td>
                      <td><span>4.9</span></td>
                    </tr>
              ...
              <div className="second-table d-flex align-items-start gap-2">
                <table>
                  <tr>
                    <td className="subject"><span>Result Status</span></td>
                    <td><span>Passed</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>Section Position</span></td>
                    <td><span>5</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>GPA [Without 4th]</span></td>
                    <td><span>4.6</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>Failed Subject [S]</span></td>
                    <td><span>0</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>Working Day</span></td>
                    <td><span>N/A</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>Total Present</span></td>
                    <td><span>N/A</span></td>
                  </tr>
                  <tr>
                    <td className="subject"><span>Total Absent</span></td>
                    <td><span>N/A</span></td>
                  </tr>
                </table>
                <table className="check-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="check"><span></span></td>
                      <td><span>Cultural Function</span></td>
                    </tr>
                    <tr>
                      <td className="check"><span></span></td>
                      <td><span>Average</span></td>
                      <td className="check"><span></span></td>
                      <td><span>Scout/BNCC</span></td>
                    </tr>
                    <tr>
                      <td className="check"><span></span></td>
                      <td><span>Poor</span></td>
                      <td className="check"><span></span></td>
                      <td><span>Math Olympiad</span></td>
                    </tr>
                    <tr>
