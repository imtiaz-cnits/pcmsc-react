const Migration=()=>{
    ...
    <div class="main-content">
      <div class="page-content">
                              ...
                              <div>
                                <ul>
                                  <li>
                                    <a
                                      href="#"
                                      class="link custom-open-modal-btn migrateModalBtn"
                                      data-modal="action-editmodal"
                                      >Edit</a>
        ...
        <section id="migrateModal" class="modal migrateModal">
          <div class="modal-content">
            <div id="popup-modal">
                ...
                <form>
                  ...
                  <div class="form-row">
                    <div class="form-group">
                      <label for="search-students">Student's Search *</label>
                      <input
                        type="text"
                        id="search-students"
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      <label for="birth-certificate">Student's ID *</label>
                      <input
                        type="text"
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      <label for="shift">Section Name*</label>
                      <select id="shift">
