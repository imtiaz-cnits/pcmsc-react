          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="exam-heading">
                <h3 className="heading">Exam Assign To className List</h3>
                ...
                <div className="input-group exam-group">
                  ...
                  <div>
                    <div className="entries-page">
                      <label for="entries" className="mr-2">Entries:</label>
              ...
              <div id="pagination" className="pagination">
                ...
                <a href="#" className="page-link page-link--1">1</a>
                <a href="#" className="page-link page-link--2">2</a>
                <a href="#" className="page-link page-link--3">3</a>
                ...
                <div className="form-container">
                  ...
                  <form>
                    ...
                    <div className="form-row row">
                      ...
                      <div className="form-group col-12">
                        <label for="vanilla-datepicker">Date of Birth *</label>
