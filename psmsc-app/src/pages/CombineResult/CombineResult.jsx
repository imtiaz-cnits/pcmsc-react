          ...
          <div className="all-session-exam">
            ...
            <div className="marksheet-container-wrap">
                ...
                <div className="info-wrapper info-wrapper2">
                  ...
                  <div className="board-info">
                    ...
                    <div className="button">
                      <button className="print-icon" onClick="printAllExamSheet()">
                        <span>
                          <svg
                            width="44"
                            height="44"
              ...
              <div className="grade-sheet">
                ...
                <div className="second-table d-flex gap-2">
                  <table>
                    <thead>
                      <tr>
                        <th><span>Exam Name</span></th>
                        <th><span>Total Mark</span></th>
                        <th><span>Letter Grade</span></th>
                        <th><span>Grade Point</span></th>
                        <th><span>Section Position</span></th>
                        <th><span>Result Status</span></th>
                        <th><span>Without 4th</span></th>
                        <th><span>Failed Subjects</span></th>
                        <th><span>Working Days</span></th>
                        <th><span>Total Present</span></th>
                        <th><span>Total Absent</span></th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="subject"><span>Half Yearly</span></td>
                        <td><span>566</span></td>
                        <td><span>A</span></td>
                        <td><span>4.64</span></td>
                        <td><span>9</span></td>
                      ...
                      <tr>
                        <td className="subject"><span>Annual Exam</span></td>
                        <td><span>566</span></td>
                        <td><span>A+</span></td>
                        <td><span>4.64</span></td>
                        <td><span>9</span></td>
                      ...
                      <tr>
                        <td className="subject"><span>Grand Final</span></td>
                        <td><span>566</span></td>
                        <td><span>A+</span></td>
                        <td><span>4.64</span></td>
                        <td><span>9</span></td>
                  ...
                  <div className="check-table-wrapper">
                    <table className="check-table">
                      <thead>
                        <tr>
                          <th colSpan="8">Moral & Behavior Evaluation</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                      ...
                      <thead>
                        <tr>
                          <th colSpan="8">Co-Curricular Activities</th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                        ...
                        <tr>
                          <td rowSpan="4" colSpan="8" className="comments">
                            <span>Comments:</span>
                          </td>
                        </tr>
                      </tbody>
